...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public List<AppointmentSchedulesResponse> getAppointmentSchedulesByPatient(String patientId) {
        ...
        Patients patients = patientsRepository.findByPatientId(patientId).orElseThrow(()-> new DataNotFoundException("Patients does not exist"));
    ...
    public List<AppointmentSchedulesResponse> getAppointmentSchedulesByDoctor(String doctorId) {
        ...
        Doctor doctor = doctorRepository.findById(doctorId).orElseThrow(()-> new DataNotFoundException("Doctor does not exist"));
    ...
    public AppointmentSchedulesResponse createAppointmentSchedules(AppointmentSchedulesRequest request) {
        ...
        Patients patients = patientsRepository.findByPatientId(request.getPatientsId()).orElseThrow(()-> new DataNotFoundException("Doctor does not exist"));
    ...
    @Override
    public AppointmentSchedulesResponse updateAppointmentSchedules(AppointmentSchedulesRequest request, String appointmentSchedulesId) {
    ...
    public AppointmentSchedulesResponse setupResponse(AppointmentSchedules item){
        ...
        patientResponse.setFullName(item.getPatients().getFullName());
        patientResponse.setDateOfBirth(item.getPatients().getDateOfBirth());
        patientResponse.setContactNumber(item.getPatients().getContactNumber());
        patientResponse.setEmail(item.getPatients().getEmail());
        patientResponse.setAddress(item.getPatients().getAddress());
